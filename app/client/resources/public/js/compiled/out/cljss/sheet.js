...
var m__43050__auto__ = (cljss.sheet.insert_BANG_[goog.typeOf(x__43049__auto__)]);
if(!((m__43050__auto__ == null))){
return m__43050__auto__.call(null,this$,css,cls_name);
} else {
var m__43050__auto____$1 = (cljss.sheet.insert_BANG_["_"]);
if(!((m__43050__auto____$1 == null))){
return m__43050__auto____$1.call(null,this$,css,cls_name);
} else {
...
var x__43049__auto__ = (((this$ == null))?null:this$);
var m__43050__auto__ = (cljss.sheet.flush_BANG_[goog.typeOf(x__43049__auto__)]);
if(!((m__43050__auto__ == null))){
return m__43050__auto__.call(null,this$);
} else {
var m__43050__auto____$1 = (cljss.sheet.flush_BANG_["_"]);
if(!((m__43050__auto____$1 == null))){
...
var x__43049__auto__ = (((this$ == null))?null:this$);
var m__43050__auto__ = (cljss.sheet.filled_QMARK_[goog.typeOf(x__43049__auto__)]);
if(!((m__43050__auto__ == null))){
return m__43050__auto__.call(null,this$);
} else {
var m__43050__auto____$1 = (cljss.sheet.filled_QMARK_["_"]);
if(!((m__43050__auto____$1 == null))){
return m__43050__auto____$1.call(null,this$);
} else {
...
return goog.dom.appendChild(self__.tag,goog.dom.createTextNode(rule));
} else {
try{return self__.sheet.insertRule(rule,rules_count);
}catch (e66732){var e = e66732;
if(cljss.utils.dev_QMARK_){
return console.warn("Illegal CSS rule",rule);
} else {
return null;
}
}}
...
cljss.sheet.Sheet.cljs$lang$ctorPrWriter = (function (this__42859__auto__,writer__42860__auto__,opt__42861__auto__){
return cljs.core._write.call(null,writer__42860__auto__,"cljss.sheet/Sheet");
});
...
//# sourceMappingURL=sheet.js.map?rel=1512632036338
