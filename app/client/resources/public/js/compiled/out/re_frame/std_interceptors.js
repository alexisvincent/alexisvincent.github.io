...
var vec__45426_45429 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_45430 = cljs.core.nth.call(null,vec__45426_45429,(0),null);
var only_after_45431 = cljs.core.nth.call(null,vec__45426_45429,(1),null);
var db_changed_QMARK__45432 = (!((only_before_45430 == null))) || (!((only_after_45431 == null)));
if(db_changed_QMARK__45432){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_45430);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_45431);
...
var map__45433 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__45433__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__45433__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__45435 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__45435__$1;
var event = cljs.core.get.call(null,map__45435__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__44087__auto___45438 = arguments.length;
var i__44088__auto___45439 = (0);
while(true){
if((i__44088__auto___45439 < len__44087__auto___45438)){
args__44094__auto__.push((arguments[i__44088__auto___45439]));

var G__45440 = (i__44088__auto___45439 + (1));
i__44088__auto___45439 = G__45440;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__44095__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq45437){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45437));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__42312__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__44094__auto__ = [];
var len__44087__auto___45447 = arguments.length;
var i__44088__auto___45448 = (0);
while(true){
if((i__44088__auto___45448 < len__44087__auto___45447)){
args__44094__auto__.push((arguments[i__44088__auto___45448]));

var G__45449 = (i__44088__auto___45448 + (1));
i__44088__auto___45448 = G__45449;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__44095__auto__);
});
...
return (function (p1__45441_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__45441_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__45442_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__45442_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__42286__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq45443){
var G__45444 = cljs.core.first.call(null,seq45443);
var seq45443__$1 = cljs.core.next.call(null,seq45443);
var G__45445 = cljs.core.first.call(null,seq45443__$1);
var seq45443__$2 = cljs.core.next.call(null,seq45443__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__45444,G__45445,seq45443__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1509370369868
