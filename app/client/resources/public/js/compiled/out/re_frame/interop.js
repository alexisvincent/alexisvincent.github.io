...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__51503 = cljs.core.instance_QMARK_;
var expr__51504 = reactive_val;
if(cljs.core.truth_(pred__51503.call(null,reagent.ratom.RAtom,expr__51504))){
return "ra";
} else {
if(cljs.core.truth_(pred__51503.call(null,reagent.ratom.RCursor,expr__51504))){
return "rc";
} else {
if(cljs.core.truth_(pred__51503.call(null,reagent.ratom.Reaction,expr__51504))){
return "rx";
} else {
if(cljs.core.truth_(pred__51503.call(null,reagent.ratom.Track,expr__51504))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1509370036100
