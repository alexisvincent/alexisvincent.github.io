...
var x__43049__auto__ = (((server_ch == null))?null:server_ch);
var m__43050__auto__ = (taoensso.sente.interfaces.sch_open_QMARK_[goog.typeOf(x__43049__auto__)]);
if(!((m__43050__auto__ == null))){
return m__43050__auto__.call(null,server_ch);
} else {
var m__43050__auto____$1 = (taoensso.sente.interfaces.sch_open_QMARK_["_"]);
if(!((m__43050__auto____$1 == null))){
return m__43050__auto____$1.call(null,server_ch);
} else {
...
var x__43049__auto__ = (((server_ch == null))?null:server_ch);
var m__43050__auto__ = (taoensso.sente.interfaces.sch_close_BANG_[goog.typeOf(x__43049__auto__)]);
if(!((m__43050__auto__ == null))){
return m__43050__auto__.call(null,server_ch);
} else {
var m__43050__auto____$1 = (taoensso.sente.interfaces.sch_close_BANG_["_"]);
if(!((m__43050__auto____$1 == null))){
return m__43050__auto____$1.call(null,server_ch);
} else {
...
var x__43049__auto__ = (((server_ch == null))?null:server_ch);
var m__43050__auto__ = (taoensso.sente.interfaces._sch_send_BANG_[goog.typeOf(x__43049__auto__)]);
if(!((m__43050__auto__ == null))){
return m__43050__auto__.call(null,server_ch,msg,close_after_send_QMARK_);
} else {
var m__43050__auto____$1 = (taoensso.sente.interfaces._sch_send_BANG_["_"]);
if(!((m__43050__auto____$1 == null))){
return m__43050__auto____$1.call(null,server_ch,msg,close_after_send_QMARK_);
} else {
...
var x__43049__auto__ = (((server_ch_adapter == null))?null:server_ch_adapter);
var m__43050__auto__ = (taoensso.sente.interfaces.ring_req__GT_server_ch_resp[goog.typeOf(x__43049__auto__)]);
if(!((m__43050__auto__ == null))){
return m__43050__auto__.call(null,server_ch_adapter,ring_req,callbacks_map);
} else {
var m__43050__auto____$1 = (taoensso.sente.interfaces.ring_req__GT_server_ch_resp["_"]);
if(!((m__43050__auto____$1 == null))){
return m__43050__auto____$1.call(null,server_ch_adapter,ring_req,callbacks_map);
} else {
...
var m__43050__auto__ = (taoensso.sente.interfaces.pack[goog.typeOf(x__43049__auto__)]);
if(!((m__43050__auto__ == null))){
return m__43050__auto__.call(null,_,x);
} else {
var m__43050__auto____$1 = (taoensso.sente.interfaces.pack["_"]);
if(!((m__43050__auto____$1 == null))){
return m__43050__auto____$1.call(null,_,x);
} else {
...
var x__43049__auto__ = (((_ == null))?null:_);
var m__43050__auto__ = (taoensso.sente.interfaces.unpack[goog.typeOf(x__43049__auto__)]);
if(!((m__43050__auto__ == null))){
return m__43050__auto__.call(null,_,x);
} else {
var m__43050__auto____$1 = (taoensso.sente.interfaces.unpack["_"]);
if(!((m__43050__auto____$1 == null))){
return m__43050__auto____$1.call(null,_,x);
} else {
...
taoensso.sente.interfaces.EdnPacker.prototype.taoensso$sente$interfaces$IPacker$ = cljs.core.PROTOCOL_SENTINEL;
...
taoensso.sente.interfaces.EdnPacker.cljs$lang$ctorPrWriter = (function (this__42859__auto__,writer__42860__auto__,opt__42861__auto__){
return cljs.core._write.call(null,writer__42860__auto__,"taoensso.sente.interfaces/EdnPacker");
});
...
if(((!((x == null)))?(((false) || ((cljs.core.PROTOCOL_SENTINEL === x.taoensso$sente$interfaces$IPacker$)))?true:(((!x.cljs$lang$protocol_mask$partition$))?cljs.core.native_satisfies_QMARK_.call(null,taoensso.sente.interfaces.IPacker,x):false)):cljs.core.native_satisfies_QMARK_.call(null,taoensso.sente.interfaces.IPacker,x))){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Given packer doesn't satisfy IPacker protocol?"].join('')),"\n","(satisfies? IPacker x)"].join('')));
}
...
//# sourceMappingURL=interfaces.js.map?rel=1512631537209
