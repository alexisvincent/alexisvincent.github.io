...
var G__51531 = cljs.core.first.call(null,poshdb);
...
var G__51533 = cljs.core.cons.call(null,pdb,path);
var G__51534 = posh.lib.db.get_parent_db.call(null,pdb);
path = G__51533;
pdb = G__51534;
continue;
} else {
...
var G__51535 = posh.lib.db.get_parent_db.call(null,poshdb);
poshdb = G__51535;
continue;
}
break;
...
var filter = cljs.core.get.call(null,map__51538__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.call(null,map__51538__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.call(null,map__51538__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.call(null,map__51538__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__42507__auto__ = db;
if(cljs.core.truth_(or__42507__auto__)){
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__51541,poshdb){
var map__51542 = p__51541;
var map__51542__$1 = ((((!((map__51542 == null)))?((((map__51542.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51542.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51542):map__51542);
var posh_tree = map__51542__$1;
var dcfg = cljs.core.get.call(null,map__51542__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.call(null,map__51542__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.call(null,cljs.core.first.call(null,poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
...
//# sourceMappingURL=db.js.map?rel=1509370036255
