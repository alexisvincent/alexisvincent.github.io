...
return cljs.core.keyword.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.namespace.call(null,attr)),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reduce.call(null,cljs.core.str,cljs.core.rest.call(null,cljs.core.name.call(null,attr))))].join(''));
} else {
return null;
}
});
...
return cljs.core.vec.call(null,cljs.core.map.call(null,(function (p1__49729_SHARP_){
if(cljs.core.coll_QMARK_.call(null,p1__49729_SHARP_)){
return posh.lib.pull_analyze.insert_dbid.call(null,p1__49729_SHARP_);
} else {
return p1__49729_SHARP_;
}
...
var and__42286__auto__ = cljs.core.map_QMARK_.call(null,v);
...
var and__42286__auto__ = cljs.core.vector_QMARK_.call(null,v);
if(and__42286__auto__){
...
var temp__5278__auto__ = cljs.core.get.call(null,schema,attr);
...
var vec__49733 = cljs.core.first.call(null,pull_map);
var k = cljs.core.nth.call(null,vec__49733,(0),null);
...
})())?cljs.core.concat.call(null,((cljs.core.not.call(null,r_QMARK_))?cljs.core.mapcat.call(null,((function (vec__49733,k,v,r_QMARK_,k__$1){
return (function (p1__49730_SHARP_){
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,k__$1,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__49730_SHARP_)], null)],null));
});})(vec__49733,k,v,r_QMARK_,k__$1))
,v):null),cljs.core.mapcat.call(null,((function (vec__49733,k,v,r_QMARK_,k__$1){
return (function (p1__49731_SHARP_){
return posh.lib.pull_analyze.tx_datoms_for_pull_map.call(null,schema,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__49731_SHARP_),cljs.core.merge.call(null,(cljs.core.truth_(r_QMARK_)?cljs.core.PersistentArrayMap.createAsIfByAssoc([k__$1,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","id","db/id",-1388397098),entity_id], null)]):null),p1__49731_SHARP_));
});})(vec__49733,k,v,r_QMARK_,k__$1))
...
return cljs.core.concat.call(null,(cljs.core.truth_(posh.lib.pull_analyze.cardinality_many_QMARK_.call(null,schema,k__$1))?cljs.core.mapcat.call(null,((function (vec__49733,k,v,r_QMARK_,k__$1){
return (function (p1__49732_SHARP_){
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,k__$1,p1__49732_SHARP_], null)],null));
});})(vec__49733,k,v,r_QMARK_,k__$1))
...
var and__42286__auto__ = cljs.core.seq_QMARK_.call(null,x);
if(and__42286__auto__){
...
var entity_keys = cljs.core.remove.call(null,(function (p1__49736_SHARP_){
return (cljs.core.map_QMARK_.call(null,p1__49736_SHARP_)) || (cljs.core._EQ_.call(null,new cljs.core.Keyword("db","id","db/id",-1388397098),p1__49736_SHARP_));
}),pull_pattern);
var val_keys = cljs.core.remove.call(null,((function (entity_keys){
return (function (p1__49737_SHARP_){
var or__42312__auto__ = posh.lib.pull_analyze.reverse_lookup_QMARK_.call(null,p1__49737_SHARP_);
if(cljs.core.truth_(or__42312__auto__)){
return or__42312__auto__;
} else {
return posh.lib.pull_analyze.ref_QMARK_.call(null,schema,p1__49737_SHARP_);
}
});})(entity_keys))
,entity_keys);
...
return cljs.core.concat.call(null,((cljs.core.not.call(null,(function (){var or__42312__auto__ = refs_only_QMARK_;
if(cljs.core.truth_(or__42312__auto__)){
return or__42312__auto__;
} else {
...
return (function (p__49740){
var vec__49741 = p__49740;
var ref_key = cljs.core.nth.call(null,vec__49741,(0),null);
var ref_pull = cljs.core.nth.call(null,vec__49741,(1),null);
...
return cljs.core.concat.call(null,(cljs.core.truth_(r_QMARK_)?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"_","_",-1201019570,null),unrev_key,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(affected_pull)], null)], null):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(affected_pull),ref_key,new cljs.core.Symbol(null,"_","_",-1201019570,null)], null)], null)),(cljs.core.truth_(posh.lib.pull_analyze.recursive_val_QMARK_.call(null,ref_pull))?(cljs.core.truth_(ref_key.call(null,affected_pull))?cljs.core.mapcat.call(null,((function (r_QMARK_,unrev_key,vec__49741,ref_key,ref_pull,entity_keys,val_keys,ref_keys,starred_QMARK_,pull_maps){
return (function (p1__49738_SHARP_){
return posh.lib.pull_analyze.tx_pattern_for_pull.call(null,schema,pull_pattern,p1__49738_SHARP_,refs_only_QMARK_);
});})(r_QMARK_,unrev_key,vec__49741,ref_key,ref_pull,entity_keys,val_keys,ref_keys,starred_QMARK_,pull_maps))
,ref_key.call(null,affected_pull)):null):(cljs.core.truth_((function (){var or__42312__auto__ = r_QMARK_;
if(cljs.core.truth_(or__42312__auto__)){
return or__42312__auto__;
} else {
return posh.lib.pull_analyze.cardinality_many_QMARK_.call(null,schema,unrev_key);
}
})())?cljs.core.mapcat.call(null,((function (r_QMARK_,unrev_key,vec__49741,ref_key,ref_pull,entity_keys,val_keys,ref_keys,starred_QMARK_,pull_maps){
return (function (p1__49739_SHARP_){
return posh.lib.pull_analyze.tx_pattern_for_pull.call(null,schema,ref_pull,p1__49739_SHARP_,refs_only_QMARK_);
});})(r_QMARK_,unrev_key,vec__49741,ref_key,ref_pull,entity_keys,val_keys,ref_keys,starred_QMARK_,pull_maps))
...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__49744,pull_pattern,ent_id){
var map__49745 = p__49744;
var map__49745__$1 = ((((!((map__49745 == null)))?((((map__49745.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49745.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49745):map__49745);
var db = cljs.core.get.call(null,map__49745__$1,new cljs.core.Keyword(null,"db","db",993250759));
var db_id = cljs.core.get.call(null,map__49745__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
var schema = cljs.core.get.call(null,map__49745__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
if(cljs.core.truth_((function (){var and__42286__auto__ = ent_id;
...
posh.lib.pull_analyze.pull_many_analyze = (function posh$lib$pull_analyze$pull_many_analyze(dcfg,retrieve,p__49750,pull_pattern,ent_ids){
var map__49751 = p__49750;
var map__49751__$1 = ((((!((map__49751 == null)))?((((map__49751.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49751.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49751):map__49751);
var db = cljs.core.get.call(null,map__49751__$1,new cljs.core.Keyword(null,"db","db",993250759));
var schema = cljs.core.get.call(null,map__49751__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.call(null,map__49751__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
if(cljs.core.empty_QMARK_.call(null,retrieve)){
return null;
} else {
var resolved_ent_ids = cljs.core.map.call(null,((function (map__49751,map__49751__$1,db,schema,db_id){
return (function (p1__49747_SHARP_){
return new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg).call(null,db,p1__49747_SHARP_);
});})(map__49751,map__49751__$1,db,schema,db_id))
,ent_ids);
var affected_datoms = cljs.core.map.call(null,((function (resolved_ent_ids,map__49751,map__49751__$1,db,schema,db_id){
...
});})(resolved_ent_ids,map__49751,map__49751__$1,db,schema,db_id))
,resolved_ent_ids);
return cljs.core.merge.call(null,(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"results","results",-1134170113),null], null), null),retrieve))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"results","results",-1134170113),affected_datoms], null):null),(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"datoms-t","datoms-t",1641690868),null,new cljs.core.Keyword(null,"datoms","datoms",-290874434),null], null), null),retrieve))?(function (){var datoms = cljs.core.mapcat.call(null,((function (resolved_ent_ids,affected_datoms,map__49751,map__49751__$1,db,schema,db_id){
return (function (p1__49748_SHARP_){
return posh.lib.pull_analyze.generate_affected_tx_datoms_for_pull.call(null,schema,p1__49748_SHARP_);
});})(resolved_ent_ids,affected_datoms,map__49751,map__49751__$1,db,schema,db_id))
,affected_datoms);
return cljs.core.merge.call(null,(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"datoms","datoms",-290874434),null], null), null),retrieve))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"datoms","datoms",-290874434),cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,datoms])], null):null),(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"datoms-t","datoms-t",1641690868),null], null), null),retrieve))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"datoms-t","datoms-t",1641690868),cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,posh.lib.util.t_for_datoms.call(null,new cljs.core.Keyword(null,"q","q",689001697).cljs$core$IFn$_invoke$arity$1(dcfg),db,datoms)])], null):null));
})():null),(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"patterns","patterns",1164082024),null], null), null),retrieve))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"patterns","patterns",1164082024),cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,(function (){var patterns = cljs.core.map.call(null,((function (resolved_ent_ids,affected_datoms,map__49751,map__49751__$1,db,schema,db_id){
return (function (p1__49749_SHARP_){
return posh.lib.pull_analyze.tx_pattern_for_pull.call(null,schema,posh.lib.pull_analyze.insert_dbid.call(null,posh.lib.pull_analyze.remove_limits.call(null,pull_pattern)),p1__49749_SHARP_,false);
});})(resolved_ent_ids,affected_datoms,map__49751,map__49751__$1,db,schema,db_id))
,affected_datoms);
...
//# sourceMappingURL=pull_analyze.js.map?rel=1509370376927
