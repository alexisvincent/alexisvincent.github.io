...
posh.lib.update.update_pull = (function posh$lib$update$update_pull(p__51499,storage_key){
var map__51500 = p__51499;
var map__51500__$1 = ((((!((map__51500 == null)))?((((map__51500.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51500.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51500):map__51500);
var posh_tree = map__51500__$1;
var dcfg = cljs.core.get.call(null,map__51500__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.call(null,map__51500__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__51502 = storage_key;
var _ = cljs.core.nth.call(null,vec__51502,(0),null);
var poshdb = cljs.core.nth.call(null,vec__51502,(1),null);
var pull_pattern = cljs.core.nth.call(null,vec__51502,(2),null);
var eid = cljs.core.nth.call(null,vec__51502,(3),null);
...
posh.lib.update.update_filter_pull = (function posh$lib$update$update_filter_pull(p__51505,storage_key){
...
var posh_tree = map__51506__$1;
var dcfg = cljs.core.get.call(null,map__51506__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.call(null,map__51506__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__51508 = storage_key;
var _ = cljs.core.nth.call(null,vec__51508,(0),null);
var poshdb = cljs.core.nth.call(null,vec__51508,(1),null);
var pull_pattern = cljs.core.nth.call(null,vec__51508,(2),null);
var eid = cljs.core.nth.call(null,vec__51508,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__51511,storage_key){
...
var posh_tree = map__51512__$1;
var dcfg = cljs.core.get.call(null,map__51512__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.call(null,map__51512__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__51514 = storage_key;
var _ = cljs.core.nth.call(null,vec__51514,(0),null);
var query = cljs.core.nth.call(null,vec__51514,(1),null);
var args = cljs.core.nth.call(null,vec__51514,(2),null);
...
var poshdbmap = cljs.core.apply.call(null,cljs.core.merge,cljs.core.map.call(null,((function (vec__51514,_,query,args,retrieve__$1,qm,dbvarmap,map__51512,map__51512__$1,posh_tree,dcfg,retrieve){
return (function (p__51517){
var vec__51518 = p__51517;
var db_sym = cljs.core.nth.call(null,vec__51518,(0),null);
var poshdb = cljs.core.nth.call(null,vec__51518,(1),null);
...
});})(vec__51514,_,query,args,retrieve__$1,qm,dbvarmap,map__51512,map__51512__$1,posh_tree,dcfg,retrieve))
,dbvarmap));
var fixed_args = cljs.core.map.call(null,((function (vec__51514,_,query,args,retrieve__$1,qm,dbvarmap,poshdbmap,map__51512,map__51512__$1,posh_tree,dcfg,retrieve){
return (function (p__51521){
var vec__51522 = p__51521;
var sym = cljs.core.nth.call(null,vec__51522,(0),null);
var arg = cljs.core.nth.call(null,vec__51522,(1),null);
var or__42312__auto__ = cljs.core.get.call(null,poshdbmap,sym);
if(cljs.core.truth_(or__42312__auto__)){
return or__42312__auto__;
} else {
return arg;
}
});})(vec__51514,_,query,args,retrieve__$1,qm,dbvarmap,poshdbmap,map__51512,map__51512__$1,posh_tree,dcfg,retrieve))
...
var G__51525 = cljs.core.first.call(null,storage_key);
...
//# sourceMappingURL=update.js.map?rel=1509370378480
