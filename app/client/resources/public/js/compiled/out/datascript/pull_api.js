...
var depth = cljs.core.get.call(null,map__50443__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__50443__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__50445 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__50445__$1 = (((G__50445 == null))?null:cljs.core.persistent_BANG_.call(null,G__50445));
if((G__50445__$1 == null)){
return null;
} else {
return cljs.core.get.call(null,G__50445__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__50446){
var vec__50447 = p__50446;
var seq__50448 = cljs.core.seq.call(null,vec__50447);
var first__50449 = cljs.core.first.call(null,seq__50448);
var seq__50448__$1 = cljs.core.next.call(null,seq__50448);
var frame = first__50449;
var frames = seq__50448__$1;
var temp__5276__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
...
var or__41411__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame__$1,frames,eid);
...
var results = (function (){var G__50450 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__50450,kvps);
} else {
return G__50450;
}
})();
...
var recursion = cljs.core.get.call(null,map__50451__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__50451__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_50453 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_50453){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_50453,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_50453))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__50455){
var vec__50456 = p__50455;
var seq__50457 = cljs.core.seq.call(null,vec__50456);
var first__50458 = cljs.core.first.call(null,seq__50457);
var seq__50457__$1 = cljs.core.next.call(null,seq__50457);
var parent = first__50458;
var frames = seq__50457__$1;
var limit = cljs.core.get.call(null,opts,new cljs.core.Keyword(null,"limit","limit",-1355822363),(1000));
var found = cljs.core.not_empty.call(null,(function (){var G__50459 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__50459);
} else {
return G__50459;
}
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__50456,seq__50457,first__50458,seq__50457__$1,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__50456,seq__50457,first__50458,seq__50457__$1,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__50456,seq__50457,first__50458,seq__50457__$1,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__50456,seq__50457,first__50458,seq__50457__$1,parent,frames))
);
...
if(cljs.core.truth_((function (){var and__41384__auto__ = component_QMARK_;
...
var as_value = (function (){var G__50460 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.call(null,((function (G__50460,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__50456,seq__50457,first__50458,seq__50457__$1,parent,frames){
return (function (p1__50454_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__50454_SHARP_]);
});})(G__50460,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__50456,seq__50457,first__50458,seq__50457__$1,parent,frames))
,G__50460);
} else {
return G__50460;
}
...
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,(function (){var G__50461 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
if(single_QMARK_){
return cljs.core.first.call(null,G__50461);
} else {
return G__50461;
}
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__50462 = parent;
if(cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.call(null,G__50462,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__50462;
}
})());
...
var vec__50463 = spec;
var attr_key = cljs.core.nth.call(null,vec__50463,(0),null);
var opts = cljs.core.nth.call(null,vec__50463,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__50466){
var vec__50467 = p__50466;
var k = cljs.core.nth.call(null,vec__50467,(0),null);
var v = cljs.core.nth.call(null,vec__50467,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__50470){
var vec__50471 = p__50470;
var seq__50472 = cljs.core.seq.call(null,vec__50471);
var first__50473 = cljs.core.first.call(null,seq__50472);
var seq__50472__$1 = cljs.core.next.call(null,seq__50472);
var frame = first__50473;
var frames = seq__50472__$1;
return datascript.pull_api.expand_result.call(null,frames,datascript.pull_api.into_BANG_.call(null,new cljs.core.Keyword(null,"expand-kvps","expand-kvps",44141154).cljs$core$IFn$_invoke$arity$1(frame),(function (){var or__41411__auto__ = datascript.pull_api.single_frame_result.call(null,new cljs.core.Keyword("datascript.pull-api","expand-rev","datascript.pull-api/expand-rev",2143627459),frame);
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__50474){
var vec__50475 = p__50474;
...
var frame = first__50477;
var frames = seq__50476__$1;
var temp__5276__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"datoms","datoms",-290874434).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5276__auto__){
var datoms_by_attr = temp__5276__auto__;
var vec__50478 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__50478,(0),null);
var datoms = cljs.core.nth.call(null,vec__50478,(1),null);
...
var temp__5276__auto____$1 = cljs.core.not_empty.call(null,cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,datascript.pull_api.filter_reverse_attrs,cljs.core.get_in.call(null,frame,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pattern","pattern",242135423),new cljs.core.Keyword(null,"attrs","attrs",-2090668713)], null))));
...
var map__50481 = frame;
var map__50481__$1 = ((((!((map__50481 == null)))?((((map__50481.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50481.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50481):map__50481);
var attr = cljs.core.get.call(null,map__50481__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__50481__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__50483 = recursion;
if(!((attr == null))){
return datascript.pull_api.push_recursion.call(null,G__50483,attr,eid);
} else {
return G__50483;
}
})();
...
var map__50484 = frame;
var map__50484__$1 = ((((!((map__50484 == null)))?((((map__50484.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50484.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50484):map__50484);
var eid = cljs.core.get.call(null,map__50484__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__50484__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var or__41411__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame,frames,eid);
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__50486){
while(true){
var vec__50487 = p__50486;
var seq__50488 = cljs.core.seq.call(null,vec__50487);
var first__50489 = cljs.core.first.call(null,seq__50488);
var seq__50488__$1 = cljs.core.next.call(null,seq__50488);
var frame = first__50489;
var frames = seq__50488__$1;
var temp__5276__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5276__auto__){
var eids = temp__5276__auto__;
...
var temp__5276__auto____$1 = cljs.core.seq.call(null,new cljs.core.Keyword(null,"specs","specs",1426570741).cljs$core$IFn$_invoke$arity$1(frame));
...
var G__50490 = db;
var G__50491 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__50490;
p__50486 = G__50491;
continue;
}
...
while(true){
var G__50492 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames));
var G__50492__$1 = (((G__50492 instanceof cljs.core.Keyword))?G__50492.fqn:null);
switch (G__50492__$1) {
case "expand":
var G__50499 = db;
var G__50500 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__50499;
frames = G__50500;
continue;
...
case "expand-rev":
var G__50501 = db;
var G__50502 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__50501;
frames = G__50502;
continue;
...
case "pattern":
var G__50503 = db;
var G__50504 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__50503;
frames = G__50504;
continue;
...
case "recursion":
var G__50505 = db;
var G__50506 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__50505;
frames = G__50506;
continue;
...
var f = first__50495;
var remaining = seq__50494__$1;
var result = (function (){var G__50496 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first.call(null,G__50496);
} else {
return G__50496;
}
})();
...
var G__50507 = db;
var G__50508 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__50497 = cljs.core.first.call(null,remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.call(null,G__50497,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__50497;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50492__$1)].join('')));
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__50509_SHARP_){
return datascript.db.entid_strict.call(null,db,p1__50509_SHARP_);
})),eids);
return datascript.pull_api.pull_pattern.call(null,db,(function (){var x__43484__auto__ = datascript.pull_api.initial_frame.call(null,pattern,eids__$1,multi_QMARK_);
...
//# sourceMappingURL=pull_api.js.map?rel=1512631529881
