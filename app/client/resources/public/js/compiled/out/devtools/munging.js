...
var o63434 = temp__5276__auto__;
var temp__5276__auto____$1 = (o63434["core"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o63435 = temp__5276__auto____$1;
return (o63435["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__62513__auto__ = f;
return (o__62513__auto__["toString"]).call(o__62513__auto__);
} else {
return "";
}
}catch (e63436){var _ = e63436;
return "";
}});
...
try{var o__62513__auto___63438 = t;
(o__62513__auto___63438["cljs$lang$ctorPrWriter"]).call(o__62513__auto___63438,t,writer);
}catch (e63437){var __63439 = e63437;
}
...
var char_code = (function (){var o__62513__auto__ = (new String(char$));
return (o__62513__auto__["charCodeAt"]).call(o__62513__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__62513__auto__ = String;
return (o__62513__auto__["fromCharCode"]).call(o__62513__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__63440 = num_code;
switch (G__63440) {
case (1):
return (185);
...
var o__62513__auto__ = String;
return (o__62513__auto__["fromCharCode"]).call(o__62513__auto__,superscript_code);
});
/**
...
}catch (e63442){var _e__62520__auto__ = e63442;
return false;
}})())){
...
var vec__63443 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__63443,(0),null);
...
var or__41411__auto__ = (function (){var temp__5276__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5276__auto__)){
...
if(cljs.core.truth_(temp__5276__auto__)){
var o63446 = temp__5276__auto__;
var temp__5276__auto____$1 = (o63446["dependencies_"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o63447 = temp__5276__auto____$1;
return (o63447["nameToPath"]);
} else {
return null;
}
} else {
...
var len__44089__auto___63454 = arguments.length;
var i__44090__auto___63455 = (0);
while(true){
if((i__44090__auto___63455 < len__44089__auto___63454)){
args__44096__auto__.push((arguments[i__44090__auto___63455]));

var G__63456 = (i__44090__auto___63455 + (1));
i__44090__auto___63455 = G__63456;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__44097__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__63450){
var vec__63451 = p__63450;
var ns_detector = cljs.core.nth.call(null,vec__63451,(0),null);
var effective_detector = (function (){var or__41411__auto__ = ns_detector;
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
...
var G__63457 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__63458 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__63457;
remaining_tokens = G__63458;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq63448){
var G__63449 = cljs.core.first.call(null,seq63448);
var seq63448__$1 = cljs.core.next.call(null,seq63448);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__63449,seq63448__$1);
});
...
var vec__63462 = cljs.core.split_with.call(null,(function (p1__63461_SHARP_){
return cljs.core.not_EQ_.call(null,p1__63461_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__63462,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__63462,(1),null);
...
var vec__63465 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__63465,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__63465,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__63468 = cljs.core.rest.call(null,remaining_tokens);
var G__63469 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__63468;
name_tokens = G__63469;
continue;
} else {
...
var vec__63472 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__63472,(0),null);
var arity = cljs.core.nth.call(null,vec__63472,(1),null);
var vec__63475 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__63475,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__63475,(1),null);
var vec__63478 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__63478,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__63478,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__63478,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__63478,(3),null);
...
var vec__63484 = result;
var munged_ns = cljs.core.nth.call(null,vec__63484,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__63484,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__63484,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__63484,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__63484,(4),null);
var arity = cljs.core.nth.call(null,vec__63484,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__63488 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__63488,(0),null);
var args = cljs.core.nth.call(null,vec__63488,(1),null);
var vec__63491 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__63491,(0),null);
var name = cljs.core.nth.call(null,vec__63491,(1),null);
...
var G__63494 = (arity + (1));
var G__63495 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__63496){
var vec__63497 = p__63496;
var arity = cljs.core.nth.call(null,vec__63497,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__63497,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__41411__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
...
return (function (p1__63500_SHARP_){
return cljs.core.get.call(null,arities,p1__63500_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__63501_SHARP_){
return cljs.core.drop.call(null,(2),p1__63501_SHARP_);
...
var args__44096__auto__ = [];
var len__44089__auto___63508 = arguments.length;
var i__44090__auto___63509 = (0);
while(true){
if((i__44090__auto___63509 < len__44089__auto___63508)){
args__44096__auto__.push((arguments[i__44090__auto___63509]));

var G__63510 = (i__44090__auto___63509 + (1));
i__44090__auto___63509 = G__63510;
continue;
} else {
}
break;
...
var argseq__44097__auto__ = ((((1) < args__44096__auto__.length))?(new cljs.core.IndexedSeq(args__44096__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__44097__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__63504){
var vec__63505 = p__63504;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__63505,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq63502){
var G__63503 = cljs.core.first.call(null,seq63502);
var seq63502__$1 = cljs.core.next.call(null,seq63502);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__63503,seq63502__$1);
});
...
var G__63511 = arg;
var G__63511__$1 = (((G__63511 instanceof cljs.core.Keyword))?G__63511.fqn:null);
switch (G__63511__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__41411__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__41384__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__41411__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
...
var map__63513 = options;
var map__63513__$1 = ((((!((map__63513 == null)))?((((map__63513.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63513.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__63513):map__63513);
var include_ns_QMARK_ = cljs.core.get.call(null,map__63513__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__63513__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__63513__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__63513__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__63514 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__63514,(0),null);
var fn_name = cljs.core.nth.call(null,vec__63514,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__63514,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__63514,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__63514,(4),null);
var arity = cljs.core.nth.call(null,vec__63514,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__41384__auto__ = protocol_ns;
if(cljs.core.truth_(and__41384__auto__)){
return cljs.core.not.call(null,(function (){var and__41384__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__41411__auto__ = protocol_part;
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
return fn_part;
...
var o__62513__auto__ = f;
return (o__62513__auto__["getBasis"]).call(o__62513__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__41384__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__41384__auto__)){
...
}catch (e63518){var _e__62520__auto__ = e63518;
...
var G__63519 = (obj[cljs.core.first.call(null,path)]);
var G__63520 = cljs.core.rest.call(null,path);
obj = G__63519;
path = G__63520;
continue;
} else {
...
var partition_bits = (function (){var or__41411__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
return (0);
...
return (function (accum,p__63521){
var vec__63522 = p__63521;
var bit = cljs.core.nth.call(null,vec__63522,(0),null);
var protocol = cljs.core.nth.call(null,vec__63522,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__63525){
var vec__63526 = p__63525;
var ns = cljs.core.nth.call(null,vec__63526,(0),null);
var name = cljs.core.nth.call(null,vec__63526,(1),null);
var selector = cljs.core.nth.call(null,vec__63526,(2),null);
...
return (function (p__63530){
var vec__63531 = p__63530;
var munged_name = cljs.core.nth.call(null,vec__63531,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__63531,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__63531,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__63529_SHARP_){
return (obj[cljs.core.first.call(null,p1__63529_SHARP_)]);
});})(name,sorted_matches,vec__63531,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1512631545956
