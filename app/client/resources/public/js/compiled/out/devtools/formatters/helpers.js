...
var G__63536 = devtools.prefs.pref.call(null,v);
v = G__63536;
continue;
} else {
return v;
...
var and__41384__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__41384__auto__){
var and__41384__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__41411__auto__ = (function (){try{if(!((value == null))){
...
}catch (e63539){var _e__62520__auto__ = e63539;
return false;
}})();
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
var or__41411__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e63543){var _e__62520__auto__ = e63543;
return false;
}})();
...
}catch (e63545){var _e__62520__auto__ = e63545;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__41384__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__41384__auto__)){
var and__41384__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__41384__auto____$1){
...
var and__41384__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__41384__auto__)){
...
var or__41411__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
...
var and__41384__auto__ = (function (){var or__41411__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
...
var vec__63547 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__63547,(0),null);
var name = cljs.core.nth.call(null,vec__63547,(1),null);
...
var and__41384__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__41384__auto__)){
...
var or__41411__auto__ = typeof value === 'string';
if(or__41411__auto__){
return or__41411__auto__;
} else {
var or__41411__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__63550_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__63550_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1512631546099
