...
var len__44089__auto___63565 = arguments.length;
var i__44090__auto___63566 = (0);
while(true){
if((i__44090__auto___63566 < len__44089__auto___63565)){
args__44096__auto__.push((arguments[i__44090__auto___63566]));

var G__63567 = (i__44090__auto___63566 + (1));
i__44090__auto___63566 = G__63567;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__44097__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq63562){
var G__63563 = cljs.core.first.call(null,seq63562);
var seq63562__$1 = cljs.core.next.call(null,seq63562);
var G__63564 = cljs.core.first.call(null,seq63562__$1);
var seq63562__$2 = cljs.core.next.call(null,seq63562__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__63563,G__63564,seq63562__$2);
});
...
if(cljs.core.truth_((function (){var or__41411__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__42859__auto__,writer__42860__auto__,opt__42861__auto__){
return cljs.core._write.call(null,writer__42860__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__41384__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__41384__auto__){
var or__41411__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__63568_SHARP_){
return !((cljs.core.meta.call(null,p1__63568_SHARP_) == null));
})))){
...
var map__63569 = opts;
var map__63569__$1 = ((((!((map__63569 == null)))?((((map__63569.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63569.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__63569):map__63569);
var markup_db = cljs.core.get.call(null,map__63569__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__41411__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e63573){var _e__62520__auto__ = e63573;
return false;
}})();
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
...
}catch (e63575){var _e__62520__auto__ = e63575;
return false;
}}
})())){
...
var _STAR_current_state_STAR_63577 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__63578 = opts;
var map__63578__$1 = ((((!((map__63578 == null)))?((((map__63578.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63578.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__63578):map__63578);
var markup_db = cljs.core.get.call(null,map__63578__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_63577;
}});
...
;
var temp__5276__auto___63582 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5276__auto___63582)){
var managed_print_level_63583 = temp__5276__auto___63582;
var _STAR_print_level_STAR_63581_63584 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_63583;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_63581_63584,managed_print_level_63583,temp__5276__auto___63582,writer,opts,job_fn){
return (function (p1__63580_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__63580_SHARP_,null);
});})(_STAR_print_level_STAR_63581_63584,managed_print_level_63583,temp__5276__auto___63582,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_63581_63584;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1512631546255
