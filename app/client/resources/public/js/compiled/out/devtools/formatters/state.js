...
var len__44089__auto___63556 = arguments.length;
var i__44090__auto___63557 = (0);
while(true){
if((i__44090__auto___63557 < len__44089__auto___63556)){
args__44096__auto__.push((arguments[i__44090__auto___63557]));

var G__63558 = (i__44090__auto___63557 + (1));
i__44090__auto___63557 = G__63558;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__44097__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq63554){
var G__63555 = cljs.core.first.call(null,seq63554);
var seq63554__$1 = cljs.core.next.call(null,seq63554);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__63555,seq63554__$1);
});
...
return (function (p1__63559_SHARP_){
return (p1__63559_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1512631546153
