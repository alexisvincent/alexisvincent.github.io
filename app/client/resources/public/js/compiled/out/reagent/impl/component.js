...
if((i < len)){
var k = (ks[i]);
var G__46973 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__46974 = (i + (1));
m = G__46973;
i = G__46974;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__46976 = c;
var G__46976__$1 = (((G__46976 == null))?null:G__46976.prototype);
if((G__46976__$1 == null)){
return null;
} else {
return (G__46976__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__46978 = c;
var G__46978__$1 = (((G__46978 == null))?null:G__46978.prototype);
if((G__46978__$1 == null)){
return null;
} else {
return (G__46978__$1["render"]);
}
})() == null)));
});
...
return (function() { 
var G__46981__delegate = function (args){
...
while (G__46982__i < G__46982__a.length) {G__46982__a[G__46982__i] = arguments[G__46982__i + 0]; ++G__46982__i;}
  args = new cljs.core.IndexedSeq(G__46982__a,0,null);
} 
return G__46981__delegate.call(this,args);};
G__46981.cljs$lang$maxFixedArity = 0;
G__46981.cljs$lang$applyTo = (function (arglist__46983){
var args = cljs.core.seq(arglist__46983);
return G__46981__delegate(args);
});
...
var _STAR_current_component_STAR_46985 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_46985;
}});
...
return ((function (G__46986,G__46986__$1){
...
var or__41411__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__46987_46989 = (c["cljsRatom"]);
if((G__46987_46989 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__46987_46989);
}
...
if(cljs.core.truth_((function (){var and__41384__auto__ = wrap;
...
var renders_46991 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_46992 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_46991));
if((cljs.core.count.call(null,renders_46991) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_46991))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_46992)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_46992))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__41411__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
...
var render_fun__$1 = (function (){var or__41411__auto__ = render_fun;
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__41411__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
...
var name__$1 = (function (){var G__46990 = name;
switch (G__46990) {
case "":
...
var G__46994 = o;
(G__46994[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__46995 = fiber;
var G__46995__$1 = (((G__46995 == null))?null:(G__46995["type"]));
if((G__46995__$1 == null)){
return null;
} else {
return (G__46995__$1["displayName"]);
}
})();
var parent = (function (){var G__46996 = fiber;
if((G__46996 == null)){
return null;
} else {
return (G__46996["return"]);
}
})();
var path = (function (){var G__46997 = parent;
var G__46997__$1 = (((G__46997 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__46997));
if((G__46997__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46997__$1)," > "].join('');
}
})();
...
var temp__5276__auto__ = (function (){var G__46998 = c;
if((G__46998 == null)){
return null;
} else {
return (G__46998["_reactInternalFiber"]);
}
})();
...
var elem = (function (){var G__46999 = (function (){var or__41411__auto__ = (function (){var G__47001 = c;
if((G__47001 == null)){
return null;
} else {
return (G__47001["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
...
if((G__47003__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47003__$2)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var n = (function (){var or__41411__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
var G__47004 = c;
var G__47004__$1 = (((G__47004 == null))?null:G__47004.constructor);
if((G__47004__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__47004__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1512631524602
