...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__42859__auto__,writer__42860__auto__,opt__42861__auto__){
return cljs.core._write.call(null,writer__42860__auto__,"reagent.impl.template/NativeWrapper");
});
...
var temp__5280__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.prop_name_cache,cljs.core.name.call(null,k));
...
var G__47017 = o;
(G__47017[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__47018__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__47018 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__47019__i = 0, G__47019__a = new Array(arguments.length -  0);
while (G__47019__i < G__47019__a.length) {G__47019__a[G__47019__i] = arguments[G__47019__i + 0]; ++G__47019__i;}
  args = new cljs.core.IndexedSeq(G__47019__a,0,null);
} 
return G__47018__delegate.call(this,args);};
G__47018.cljs$lang$maxFixedArity = 0;
G__47018.cljs$lang$applyTo = (function (arglist__47020){
var args = cljs.core.seq(arglist__47020);
return G__47018__delegate(args);
});
G__47018.cljs$core$IFn$_invoke$arity$variadic = G__47018__delegate;
return G__47018;
})()
;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__47022){
var map__47023 = p__47022;
var map__47023__$1 = ((((!((map__47023 == null)))?((((map__47023.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47023.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__47023):map__47023);
var props = map__47023__$1;
var class$ = cljs.core.get.call(null,map__47023__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__47025){
var map__47026 = p__47025;
...
var on_write = cljs.core.get.call(null,map__47026__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__47026,map__47026__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__47026,map__47026__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__47031){
var map__47032 = p__47031;
var map__47032__$1 = ((((!((map__47032 == null)))?((((map__47032.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47032.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__47032):map__47032);
var synthetic_on_update = cljs.core.get.call(null,map__47032__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.call(null,map__47032__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
if(cljs.core.truth_((function (){var and__41384__auto__ = !((jsprops == null));
if(and__41384__auto__){
var and__41384__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__47034 = jsprops;
(G__47034["defaultValue"] = value);

(G__47034["onChange"] = ((function (G__47034,v,value,on_change,on_change__$1,map__47032,map__47032__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__47028_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change__$1,p1__47028_SHARP_);
});})(G__47034,v,value,on_change,on_change__$1,map__47032,map__47032__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__47038 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__47038,(0),null);
var id = cljs.core.nth.call(null,vec__47038,(1),null);
var class$ = cljs.core.nth.call(null,vec__47038,(2),null);
...
var temp__5280__auto__ = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
if((temp__5280__auto__ == null)){
...
var jsprops = ({"argv": v});
var temp__5282__auto___47042 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5282__auto___47042 == null)){
} else {
var key_47043 = temp__5282__auto___47042;
(jsprops["key"] = key_47043);
}
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__47046){
var map__47047 = p__47046;
var map__47047__$1 = ((((!((map__47047 == null)))?((((map__47047.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47047.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__47047):map__47047);
var synthetic_input = cljs.core.get.call(null,map__47047__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__47049 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__47049["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__47050 = wrapped;
(G__47050["syntheticInput"] = true);

return G__47050;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__47051 = wrapped__$1;
(G__47051["syntheticOnChange"] = on_change);

return G__47051;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__47052 = wrapped__$2;
(G__47052["syntheticOnUpdate"] = on_update);
...
var temp__5280__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.tag_name_cache,x);
if((temp__5280__auto__ == null)){
...
if(cljs.core.truth_((function (){var or__41411__auto__ = synthetic_input;
...
var len__44089__auto___47058 = arguments.length;
var i__44090__auto___47059 = (0);
while(true){
if((i__44090__auto___47059 < len__44089__auto___47058)){
args__44096__auto__.push((arguments[i__44090__auto___47059]));

var G__47060 = (i__44090__auto___47059 + (1));
i__44090__auto___47059 = G__47060;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__44097__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq47056){
var G__47057 = cljs.core.first.call(null,seq47056);
var seq47056__$1 = cljs.core.next.call(null,seq47056);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__47057,seq47056__$1);
});
...
break;
default:
var G__47063 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__47063;
continue;
...
var n__43665__auto___47065 = a.length;
var i_47066 = (0);
while(true){
if((i_47066 < n__43665__auto___47065)){
(a[i_47066] = reagent.impl.template.as_element.call(null,(a[i_47066])));

var G__47067 = (i_47066 + (1));
i_47066 = G__47067;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__43665__auto___47068 = a.length;
var i_47069 = (0);
while(true){
if((i_47069 < n__43665__auto___47068)){
var val_47070 = (a[i_47069]);
if((cljs.core.vector_QMARK_.call(null,val_47070)) && ((reagent.impl.template.key_from_vec.call(null,val_47070) == null))){
(o["no-key"] = true);
} else {
}

(a[i_47069] = reagent.impl.template.as_element.call(null,val_47070));

var G__47071 = (i_47069 + (1));
i_47069 = G__47071;
continue;
} else {
}
...
var ctx = ({});
var vec__47072 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__47072,(0),null);
var derefed = cljs.core.nth.call(null,vec__47072,(1),null);
...
var G__47075 = (cljs.core.count.call(null,argv) - first_child);
switch (G__47075) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__47075){
...
//# sourceMappingURL=template.js.map?rel=1512631524829
