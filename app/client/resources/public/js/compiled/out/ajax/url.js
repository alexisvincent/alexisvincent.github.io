...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__46160){
var vec__46161 = p__46160;
var k = cljs.core.nth.call(null,vec__46161,(0),null);
var v = cljs.core.nth.call(null,vec__46161,(1),null);
...
var vec_key_encode = (function (){var G__46167 = (function (){var or__41411__auto__ = vec_strategy;
...
switch (G__46167__$1) {
case "java":
return ((function (G__46167,G__46167__$1){
return (function (k){
return null;
});
;})(G__46167,G__46167__$1))
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46167__$1)].join('')));
...
ajax.url.param_to_key_value_pairs.cljs$core$IFn$_invoke$arity$3 = (function (vec_key_transform,prefix,p__46171){
var vec__46172 = p__46171;
var key = cljs.core.nth.call(null,vec__46172,(0),null);
var value = cljs.core.nth.call(null,vec__46172,(1),null);
...
return (function (p__46175){
var vec__46176 = p__46175;
var key = cljs.core.nth.call(null,vec__46176,(0),null);
var value = cljs.core.nth.call(null,vec__46176,(1),null);
...
return (function (prefix,p__46179){
var vec__46180 = p__46179;
var key = cljs.core.nth.call(null,vec__46180,(0),null);
var value = cljs.core.nth.call(null,vec__46180,(1),null);
...
ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__46189){
var map__46190 = p__46189;
var map__46190__$1 = ((((!((map__46190 == null)))?((((map__46190.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46190.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46190):map__46190);
var vec_strategy = cljs.core.get.call(null,map__46190__$1,new cljs.core.Keyword(null,"vec-strategy","vec-strategy",1843221372));
...
//# sourceMappingURL=url.js.map?rel=1512631521884
