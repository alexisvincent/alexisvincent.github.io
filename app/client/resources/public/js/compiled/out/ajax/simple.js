...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__46561){
var map__46562 = p__46561;
var map__46562__$1 = ((((!((map__46562 == null)))?((((map__46562.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46562.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46562):map__46562);
var handler = cljs.core.get.call(null,map__46562__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return (function (p1__46564_SHARP_){
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__41411__auto__ = p1__46564_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__46565){
var map__46566 = p__46565;
var map__46566__$1 = ((((!((map__46566 == null)))?((((map__46566.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46566.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46566):map__46566);
var request = map__46566__$1;
var interceptors = cljs.core.get.call(null,map__46566__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__41411__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__41411__auto__)){
return or__41411__auto__;
} else {
...
//# sourceMappingURL=simple.js.map?rel=1512631522794
