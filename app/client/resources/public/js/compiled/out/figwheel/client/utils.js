...
var or__41411__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj60226 = {"detail":data};
return obj60226;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__41384__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__41384__auto__)){
var and__41384__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__60233 = cljs.core._EQ_;
var expr__60234 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__60233.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__60234))){
return ((function (pred__60233,expr__60234){
return (function (p1__60227_SHARP_){
return console.warn(p1__60227_SHARP_);
});
;})(pred__60233,expr__60234))
} else {
if(cljs.core.truth_(pred__60233.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__60234))){
return ((function (pred__60233,expr__60234){
return (function (p1__60228_SHARP_){
return console.debug(p1__60228_SHARP_);
});
;})(pred__60233,expr__60234))
} else {
if(cljs.core.truth_(pred__60233.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__60234))){
return ((function (pred__60233,expr__60234){
return (function (p1__60229_SHARP_){
return console.error(p1__60229_SHARP_);
});
;})(pred__60233,expr__60234))
} else {
return ((function (pred__60233,expr__60234){
return (function (p1__60230_SHARP_){
return console.log(p1__60230_SHARP_);
});
;})(pred__60233,expr__60234))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__60237){
...
var eval_fn = cljs.core.get.call(null,map__60238__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__60240_SHARP_);
});})(new_def))
);
...
return (function (p__60241){
var vec__60242 = p__60241;
var ky = cljs.core.nth.call(null,vec__60242,(0),null);
var v = cljs.core.nth.call(null,vec__60242,(1),null);
...
if(cljs.core.truth_((function (){var and__41384__auto__ = typeof localStorage !== 'undefined';
...
}catch (e60247){if((e60247 instanceof Error)){
var e = e60247;
return not_found;
} else {
throw e60247;
...
//# sourceMappingURL=utils.js.map?rel=1512631541443
