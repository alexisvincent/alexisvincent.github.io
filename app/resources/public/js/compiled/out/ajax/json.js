...
if(cljs.core.truth_((function (){var and__41345__auto__ = prefix;
if(cljs.core.truth_(and__41345__auto__)){
return cljs.core._EQ_.call(null,(0),text.indexOf(prefix));
} else {
return and__41345__auto__;
}
})())){
...
var ajax$json$make_json_response_format_$_json_response_format__1 = (function (p__55359){
var map__55360 = p__55359;
var map__55360__$1 = ((((!((map__55360 == null)))?((((map__55360.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55360.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55360):map__55360);
var prefix = cljs.core.get.call(null,map__55360__$1,new cljs.core.Keyword(null,"prefix","prefix",-265908465));
var keywords_QMARK_ = cljs.core.get.call(null,map__55360__$1,new cljs.core.Keyword(null,"keywords?","keywords?",764949733));
var raw = cljs.core.get.call(null,map__55360__$1,new cljs.core.Keyword(null,"raw","raw",1604651272));
return ajax.interceptors.map__GT_ResponseFormat.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"read","read",1140058661),((function (map__55360,map__55360__$1,prefix,keywords_QMARK_,raw){
...
});})(map__55360,map__55360__$1,prefix,keywords_QMARK_,raw))
...
ajax$json$make_json_response_format_$_json_response_format = function(p__55359){
switch(arguments.length){
case 0:
return ajax$json$make_json_response_format_$_json_response_format__0.call(this);
case 1:
return ajax$json$make_json_response_format_$_json_response_format__1.call(this,p__55359);
}
...
//# sourceMappingURL=json.js.map?rel=1513007446108
