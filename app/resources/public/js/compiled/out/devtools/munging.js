...
var o56223 = temp__5455__auto__;
var temp__5455__auto____$1 = (o56223["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o56224 = temp__5455__auto____$1;
return (o56224["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__55335__auto__ = f;
return (o__55335__auto__["toString"]).call(o__55335__auto__);
} else {
return "";
}
}catch (e56225){var _ = e56225;
return "";
}});
...
try{var o__55335__auto___56227 = t;
(o__55335__auto___56227["cljs$lang$ctorPrWriter"]).call(o__55335__auto___56227,t,writer);
}catch (e56226){var __56228 = e56226;
}
...
var char_code = (function (){var o__55335__auto__ = (new String(char$));
return (o__55335__auto__["charCodeAt"]).call(o__55335__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__55335__auto__ = String;
return (o__55335__auto__["fromCharCode"]).call(o__55335__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__56229 = num_code;
switch (G__56229) {
case (1):
return (185);
...
var o__55335__auto__ = String;
return (o__55335__auto__["fromCharCode"]).call(o__55335__auto__,superscript_code);
});
/**
...
}catch (e56231){var _e__55342__auto__ = e56231;
return false;
}})())){
...
var vec__56232 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__56232,(0),null);
...
var or__41331__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o56235 = temp__5455__auto__;
var temp__5455__auto____$1 = (o56235["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o56236 = temp__5455__auto____$1;
return (o56236["nameToPath"]);
} else {
return null;
}
} else {
...
var len__44016__auto___56243 = arguments.length;
var i__44017__auto___56244 = (0);
while(true){
if((i__44017__auto___56244 < len__44016__auto___56243)){
args__44034__auto__.push((arguments[i__44017__auto___56244]));

var G__56245 = (i__44017__auto___56244 + (1));
i__44017__auto___56244 = G__56245;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__44035__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__56239){
var vec__56240 = p__56239;
var ns_detector = cljs.core.nth.call(null,vec__56240,(0),null);
var effective_detector = (function (){var or__41331__auto__ = ns_detector;
if(cljs.core.truth_(or__41331__auto__)){
return or__41331__auto__;
} else {
...
var G__56246 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__56247 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__56246;
remaining_tokens = G__56247;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq56237){
var G__56238 = cljs.core.first.call(null,seq56237);
var seq56237__$1 = cljs.core.next.call(null,seq56237);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__56238,seq56237__$1);
});
...
var vec__56251 = cljs.core.split_with.call(null,(function (p1__56250_SHARP_){
return cljs.core.not_EQ_.call(null,p1__56250_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__56251,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__56251,(1),null);
...
var vec__56254 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__56254,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__56254,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__56257 = cljs.core.rest.call(null,remaining_tokens);
var G__56258 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__56257;
name_tokens = G__56258;
continue;
} else {
...
var vec__56261 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__56261,(0),null);
var arity = cljs.core.nth.call(null,vec__56261,(1),null);
var vec__56264 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__56264,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__56264,(1),null);
var vec__56267 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__56267,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__56267,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__56267,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__56267,(3),null);
...
var vec__56273 = result;
var munged_ns = cljs.core.nth.call(null,vec__56273,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__56273,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__56273,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__56273,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__56273,(4),null);
var arity = cljs.core.nth.call(null,vec__56273,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__56277 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__56277,(0),null);
var args = cljs.core.nth.call(null,vec__56277,(1),null);
var vec__56280 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__56280,(0),null);
var name = cljs.core.nth.call(null,vec__56280,(1),null);
...
var G__56283 = (arity + (1));
var G__56284 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__56285){
var vec__56286 = p__56285;
var arity = cljs.core.nth.call(null,vec__56286,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__56286,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__41331__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__41331__auto__)){
return or__41331__auto__;
} else {
...
return (function (p1__56289_SHARP_){
return cljs.core.get.call(null,arities,p1__56289_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__56290_SHARP_){
return cljs.core.drop.call(null,(2),p1__56290_SHARP_);
...
var args__44034__auto__ = [];
var len__44016__auto___56297 = arguments.length;
var i__44017__auto___56298 = (0);
while(true){
if((i__44017__auto___56298 < len__44016__auto___56297)){
args__44034__auto__.push((arguments[i__44017__auto___56298]));

var G__56299 = (i__44017__auto___56298 + (1));
i__44017__auto___56298 = G__56299;
continue;
} else {
}
break;
...
var argseq__44035__auto__ = ((((1) < args__44034__auto__.length))?(new cljs.core.IndexedSeq(args__44034__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__44035__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__56293){
var vec__56294 = p__56293;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__56294,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq56291){
var G__56292 = cljs.core.first.call(null,seq56291);
var seq56291__$1 = cljs.core.next.call(null,seq56291);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__56292,seq56291__$1);
});
...
var G__56300 = arg;
var G__56300__$1 = (((G__56300 instanceof cljs.core.Keyword))?G__56300.fqn:null);
switch (G__56300__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__41331__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__41331__auto__)){
return or__41331__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__41318__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__41331__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__41331__auto__)){
return or__41331__auto__;
} else {
...
var map__56302 = options;
var map__56302__$1 = ((((!((map__56302 == null)))?((((map__56302.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56302.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56302):map__56302);
var include_ns_QMARK_ = cljs.core.get.call(null,map__56302__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__56302__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__56302__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__56302__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__56303 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__56303,(0),null);
var fn_name = cljs.core.nth.call(null,vec__56303,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__56303,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__56303,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__56303,(4),null);
var arity = cljs.core.nth.call(null,vec__56303,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__41318__auto__ = protocol_ns;
if(cljs.core.truth_(and__41318__auto__)){
return cljs.core.not.call(null,(function (){var and__41318__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__41331__auto__ = protocol_part;
if(cljs.core.truth_(or__41331__auto__)){
return or__41331__auto__;
} else {
return fn_part;
...
var o__55335__auto__ = f;
return (o__55335__auto__["getBasis"]).call(o__55335__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__41318__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__41318__auto__)){
...
}catch (e56307){var _e__55342__auto__ = e56307;
...
var G__56308 = (obj[cljs.core.first.call(null,path)]);
var G__56309 = cljs.core.rest.call(null,path);
obj = G__56308;
path = G__56309;
continue;
} else {
...
var partition_bits = (function (){var or__41331__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__41331__auto__)){
return or__41331__auto__;
} else {
return (0);
...
return (function (accum,p__56310){
var vec__56311 = p__56310;
var bit = cljs.core.nth.call(null,vec__56311,(0),null);
var protocol = cljs.core.nth.call(null,vec__56311,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__56314){
var vec__56315 = p__56314;
var ns = cljs.core.nth.call(null,vec__56315,(0),null);
var name = cljs.core.nth.call(null,vec__56315,(1),null);
var selector = cljs.core.nth.call(null,vec__56315,(2),null);
...
return (function (p__56319){
var vec__56320 = p__56319;
var munged_name = cljs.core.nth.call(null,vec__56320,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__56320,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__56320,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__56318_SHARP_){
return (obj[cljs.core.first.call(null,p1__56318_SHARP_)]);
});})(name,sorted_matches,vec__56320,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1513003910178
