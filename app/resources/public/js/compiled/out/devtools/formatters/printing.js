...
var len__44016__auto___56354 = arguments.length;
var i__44017__auto___56355 = (0);
while(true){
if((i__44017__auto___56355 < len__44016__auto___56354)){
args__44034__auto__.push((arguments[i__44017__auto___56355]));

var G__56356 = (i__44017__auto___56355 + (1));
i__44017__auto___56355 = G__56356;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__44035__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq56351){
var G__56352 = cljs.core.first.call(null,seq56351);
var seq56351__$1 = cljs.core.next.call(null,seq56351);
var G__56353 = cljs.core.first.call(null,seq56351__$1);
var seq56351__$2 = cljs.core.next.call(null,seq56351__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__56352,G__56353,seq56351__$2);
});
...
if(cljs.core.truth_((function (){var or__41331__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__42774__auto__,writer__42775__auto__,opt__42776__auto__){
return cljs.core._write.call(null,writer__42775__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__41318__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__41318__auto__){
var or__41331__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__41331__auto__)){
return or__41331__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__56357_SHARP_){
return !((cljs.core.meta.call(null,p1__56357_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__56358__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__41331__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e56362){var _e__55342__auto__ = e56362;
return false;
}})();
if(cljs.core.truth_(or__41331__auto__)){
return or__41331__auto__;
...
}catch (e56364){var _e__55342__auto__ = e56364;
return false;
}}
})())){
...
var _STAR_current_state_STAR_56366 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__56367 = opts;
var map__56367__$1 = ((((!((map__56367 == null)))?((((map__56367.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56367.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56367):map__56367);
var markup_db = cljs.core.get.call(null,map__56367__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_56366;
}});
...
;
var temp__5455__auto___56371 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___56371)){
var managed_print_level_56372 = temp__5455__auto___56371;
var _STAR_print_level_STAR_56370_56373 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_56372;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_56370_56373,managed_print_level_56372,temp__5455__auto___56371,writer,opts,job_fn){
return (function (p1__56369_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__56369_SHARP_,null);
});})(_STAR_print_level_STAR_56370_56373,managed_print_level_56372,temp__5455__auto___56371,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_56370_56373;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1513003910408
