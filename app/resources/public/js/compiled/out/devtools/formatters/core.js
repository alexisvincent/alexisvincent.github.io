...
var and__41318__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__41318__auto__){
var or__41331__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e56834){var _e__55342__auto__ = e56834;
return false;
...
}catch (e56836){var _e__55342__auto__ = e56836;
return false;
...
}catch (e56838){var _e__55342__auto__ = e56838;
return false;
...
}catch (e56840){var _e__55342__auto__ = e56840;
return false;
...
}catch (e56842){var _e__55342__auto__ = e56842;
return false;
}})())){
...
}catch (e56844){var _e__55342__auto__ = e56844;
return false;
}})())){
...
var _STAR_current_state_STAR_56846 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__41331__auto__ = config;
if(cljs.core.truth_(or__41331__auto__)){
return or__41331__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_56846;
}});
});
...
return (function() { 
var G__56848__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e56847){var e = e56847;
devtools.reporter.report_internal_error_BANG_.call(null,e,"an exception was raised during value formatting");

return null;
}};
var G__56848 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__56849__i = 0, G__56849__a = new Array(arguments.length -  0);
while (G__56849__i < G__56849__a.length) {G__56849__a[G__56849__i] = arguments[G__56849__i + 0]; ++G__56849__i;}
  args = new cljs.core.IndexedSeq(G__56849__a,0,null);
} 
return G__56848__delegate.call(this,args);};
G__56848.cljs$lang$maxFixedArity = 0;
G__56848.cljs$lang$applyTo = (function (arglist__56850){
var args = cljs.core.seq(arglist__56850);
return G__56848__delegate(args);
});
G__56848.cljs$core$IFn$_invoke$arity$variadic = G__56848__delegate;
return G__56848;
})()
;
});
...
var pre_handler = (function (){var or__41331__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__41331__auto__)){
return or__41331__auto__;
} else {
...
var post_handler = (function (){var or__41331__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__41331__auto__)){
return or__41331__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1513003911312
