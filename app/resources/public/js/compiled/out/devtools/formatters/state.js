...
var len__44016__auto___56345 = arguments.length;
var i__44017__auto___56346 = (0);
while(true){
if((i__44017__auto___56346 < len__44016__auto___56345)){
args__44034__auto__.push((arguments[i__44017__auto___56346]));

var G__56347 = (i__44017__auto___56346 + (1));
i__44017__auto___56346 = G__56347;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__44035__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq56343){
var G__56344 = cljs.core.first.call(null,seq56343);
var seq56343__$1 = cljs.core.next.call(null,seq56343);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__56344,seq56343__$1);
});
...
return (p1__56348_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1513003910318
