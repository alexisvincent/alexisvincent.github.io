...
var or__41331__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj50429 = {"detail":data};
return obj50429;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__41318__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__41318__auto__)){
var and__41318__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__50436 = cljs.core._EQ_;
var expr__50437 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__50436.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__50437))){
return ((function (pred__50436,expr__50437){
return (function (p1__50430_SHARP_){
return console.warn(p1__50430_SHARP_);
});
;})(pred__50436,expr__50437))
} else {
if(cljs.core.truth_(pred__50436.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__50437))){
return ((function (pred__50436,expr__50437){
return (function (p1__50431_SHARP_){
return console.debug(p1__50431_SHARP_);
});
;})(pred__50436,expr__50437))
} else {
if(cljs.core.truth_(pred__50436.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__50437))){
return ((function (pred__50436,expr__50437){
return (function (p1__50432_SHARP_){
return console.error(p1__50432_SHARP_);
});
;})(pred__50436,expr__50437))
} else {
return ((function (pred__50436,expr__50437){
return (function (p1__50433_SHARP_){
return console.log(p1__50433_SHARP_);
});
;})(pred__50436,expr__50437))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__50440){
...
var opts = map__50441__$1;
var eval_fn = cljs.core.get.call(null,map__50441__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__50443_SHARP_);
});})(new_def))
);
...
return (function (p__50444){
var vec__50445 = p__50444;
var ky = cljs.core.nth.call(null,vec__50445,(0),null);
var v = cljs.core.nth.call(null,vec__50445,(1),null);
...
if(cljs.core.truth_((function (){var and__41318__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1513003904175
